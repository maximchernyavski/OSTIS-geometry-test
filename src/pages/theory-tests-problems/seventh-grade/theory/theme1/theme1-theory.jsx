...
function Theme1 () {
    ...
    return (
        <div style={{width: '100%', height: '100%', display: 'flex', overflowX: 'hidden'}}>
            <div style={{width: '15%', minHeight: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#D7EEFF', borderRight: '1px solid #84B7EE'}}>
                <div className="theory-logo-box">
                    <img src={Logo} alt="OSTIS-geometry logo" style={{maxWidth: '8.5vh', marginLeft: '5%', cursor: 'pointer'}} onClick={(() => {navigate('/home')})}></img>
                </div>
                ...
                <div style={{height: '70%', display: 'flex', flexDirection: 'column-reverse'}}>  
                    <Button className="button" style={{width: '90%', marginTop: '100%', fontSize: '14px'}} onClick={() => {navigate('/seven-grade-tests-theory-problems')}}>Назад к выбору темы</Button>
                </div>
            </div>
            <div className="theory-tests-problems-main" style={{overflowY: 'hidden'}}>
                ...
                <div ref={anchorTargetContainer} style={{width: '100%', overflowY: 'scroll', display: 'flex', flexDirection: 'column', marginLeft: '30px', marginTop: '10px'}}>
                    <Text strong className="gradient-text" style={{fontSize: '24px'}}>I. Прямая, луч, отрезок.</Text>
                    ...
                    <div style={{display: 'flex', alignItems: 'center', marginBottom: '10px'}}>
                        <img src={pic1} alt="pic1.png" style={{width: '300px', height: '250px', marginRight: '10px'}} />
                    ...
                    <DefinitionBlock id='отрезок'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </DefinitionBlock>

                    <Text strong className="gradient-text" style={{fontSize: '24px', marginBottom: '10px'}}>II. Ломаная и её типы.</Text>

                    <DefinitionBlock id="ломаная-и-типы">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </DefinitionBlock>
